...
public class FriendAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView statusTextView = (TextView) convertView.findViewById(R.id.item_status) ;

        // Data Set(listViewItemList)에서 position에 위치한 데이터 참조 획득
        FriendItem listViewItem = listViewItemList.get(position);
    ...
    public void addItem(Drawable icon, String name, String status) {
